...
import thingsboard.dao.nosql._CassandraAbstractModelDao;
...
/*@Component
@Slf4j*/
public class CassandraAlarmDao extends _CassandraAbstractModelDao<AlarmEntity, Alarm> implements AlarmDao {
    ...
    public Alarm save(TenantId tenantId, Alarm alarm) {
        ...
        return null;//super.save(tenantId, alarm);
    }
