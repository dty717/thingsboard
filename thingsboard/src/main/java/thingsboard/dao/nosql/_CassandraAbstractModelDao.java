/**
 * Copyright 漏 2016-2019 The Thingsboard Authors
 *
...
import thingsboard.dao.model.wrapper.EntityResultSet;
...
@Slf4j
public abstract class _CassandraAbstractModelDao<E extends BaseEntity<D>, D> /*extends CassandraAbstractDao*/ implements Dao<D> {
