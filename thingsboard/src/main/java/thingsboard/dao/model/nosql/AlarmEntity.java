...
import thingsboard.dao.model.type.AlarmSeverityCodec;
import thingsboard.dao.model.type.AlarmStatusCodec;
import thingsboard.dao.model.type.EntityTypeCodec;
import thingsboard.dao.model.type.JsonCodec;

import java.util.UUID;

import static thingsboard.dao.model.ModelConstants.ALARM_ACK_TS_PROPERTY;
import static thingsboard.dao.model.ModelConstants.ALARM_CLEAR_TS_PROPERTY;
import static thingsboard.dao.model.ModelConstants.ALARM_COLUMN_FAMILY_NAME;
import static thingsboard.dao.model.ModelConstants.ALARM_DETAILS_PROPERTY;
import static thingsboard.dao.model.ModelConstants.ALARM_END_TS_PROPERTY;
...
import static thingsboard.dao.model.ModelConstants.ALARM_PROPAGATE_PROPERTY;
import static thingsboard.dao.model.ModelConstants.ALARM_SEVERITY_PROPERTY;
import static thingsboard.dao.model.ModelConstants.ALARM_START_TS_PROPERTY;
import static thingsboard.dao.model.ModelConstants.ALARM_STATUS_PROPERTY;
...
public final class AlarmEntity implements BaseEntity<Alarm> {
    ...
    public Alarm toData() {
        ...
        alarm.setOriginator((AlarmId)EntityIdFactory.getByTypeAndUuid(originatorType, originatorId));
        alarm.setType(type);
